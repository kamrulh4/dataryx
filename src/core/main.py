...
from core.configs.flow_logger import clear_all_flow_logs
...
from core.routes.catalog import router as catalog_router
from core.routes.cloud_connections import router as cloud_connections_router
from core.routes.logs import router as logs_router
from core.routes.public import router as public_router
from core.routes.routes import router
from core.routes.secrets import router as secrets_router
from core.routes.user_defined_components import router as user_defined_components_router
from core.routes.file_manager import router as file_manager_router
...
app = FastAPI(
    title="Dataryx Backend",
    version="0.1",
    description="Backend for the Dataryx application",
...
app.include_router(scheduler_router, prefix="/v1/scheduler", tags=["scheduler"])
