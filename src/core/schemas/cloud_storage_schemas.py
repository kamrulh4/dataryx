...
from core.secret_manager.secret_manager import encrypt_secret
...
class CloudStorageWriteSettingsWorkerInterface(BaseModel):
    ...
    dataryx_flow_id: int = 1
    dataryx_node_id: int | str = -1
...
def get_cloud_storage_write_settings_worker_interface(
    ...
    Args:
        ...
        dataryx_flow_id: Flow ID for tracking
        dataryx_node_id: Node ID for tracking
    ...
    return CloudStorageWriteSettingsWorkerInterface(
        ...
        dataryx_flow_id=dataryx_flow_id,
        dataryx_node_id=dataryx_node_id,
    )
