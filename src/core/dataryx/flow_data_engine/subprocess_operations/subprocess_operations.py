...
from core.configs.settings import WORKER_URL
from core.dataryx.flow_data_engine.subprocess_operations.models import (
    FuzzyJoinInput,
    OperationType,
    PolarsOperation,
    Status,
)
from core.dataryx.flow_data_engine.subprocess_operations.streaming import (
    streaming_receive,
    streaming_start,
    streaming_submit,
)
from core.dataryx.sources.external_sources.sql_source.models import (
    DatabaseExternalReadSettings,
    DatabaseExternalWriteSettings,
)
from core.schemas.cloud_storage_schemas import CloudStorageWriteSettingsWorkerInterface
from core.schemas.input_schema import ReceivedTable
from core.utils.arrow_reader import read
...
def trigger_create_operation(
    ...
    f = requests.post(
        ...
        params={"dataryx_flow_id": flow_id, "dataryx_node_id": node_id},
    )
    if not f.ok:
