...
class DatabaseExternalWriteSettings(BaseModel):
    ...
    def create_from_from_node_database_writer(
        ...
        return cls(
            ...
            dataryx_flow_id=node_database_writer.flow_id,
            dataryx_node_id=node_database_writer.node_id,
...
class DatabaseExternalReadSettings(BaseModel):
    ...
    def create_from_from_node_database_reader(
        ...
        return cls(
            connection=ext_database_connection,
            query=query,
            dataryx_flow_id=node_database_reader.flow_id,
            dataryx_node_id=node_database_reader.node_id,
        )
