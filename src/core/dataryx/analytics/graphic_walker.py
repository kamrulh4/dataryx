from core.dataryx.flow_data_engine.flow_data_engine import FlowDataEngine, DataryxColumn
from core.schemas.analysis_schemas import graphic_walker_schemas as gw_schema
...
def convert_ff_column_to_gw_field(flow_file_column: DataryxColumn) -> gw_schema.MutField:
    ...
    Args:
    - flow_file_column: An instance of DataryxColumn representing a column in the data schema.

    Returns:
    - A GraphicWalkerField instance with properties derived from the DataryxColumn.
    """
