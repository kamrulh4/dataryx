...
def calculate_fuzzy_match_schema(
    ...
    left_schema: list[DataryxColumn],
    right_schema: list[DataryxColumn],
):
...
def get_output_data_type_pivot(schema: DataryxColumn, agg_type: str) -> datatypes:
...
def pre_calculate_pivot_schema(
    node_input_schema: list[DataryxColumn],
