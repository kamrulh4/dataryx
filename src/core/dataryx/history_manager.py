...
from core.schemas.history_schema import (
    CompressedSnapshot,
    HistoryActionType,
    HistoryConfig,
    HistoryEntry,
...
from core.schemas.schemas import DataryxData
...
class HistoryManager:
    ...
    def capture_snapshot(
        ...
        try:
            # Get the current state as DataryxData
            dataryx_data = flow_graph.get_dataryx_data()
            snapshot_dict = dataryx_data.model_dump()
    ...
    def capture_if_changed(
        ...
        try:
            ...
            current_snapshot = flow_graph.get_dataryx_data()
    ...
    def undo(self, flow_graph: "FlowGraph") -> UndoRedoResult:
        ...
        try:
            ...
            snapshot_data = DataryxData.model_validate(snapshot_dict)
