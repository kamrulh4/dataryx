...
from core.schemas.input_schema import OutputFieldConfig


def create_schema_from_output_field_config(output_field_config: OutputFieldConfig) -> list[DataryxColumn]:
    """Create a DataryxColumn schema from OutputFieldConfig.
    ...
    Returns:
        List of DataryxColumn objects representing the expected output schema
    """
    ...
    schema = [
        DataryxColumn.from_input(column_name=field.name, data_type=field.data_type)
