...
class NodeSchemaInformation:
    ...
    Attributes:
        ...
        output_columns: A list of `DataryxColumn` objects that will be added by the node.
    """

    result_schema: list[DataryxColumn] | None = None
    predicted_schema: list[DataryxColumn] | None = None
    input_columns: list[str] = []
    drop_columns: list[str] = []
    output_columns: list[DataryxColumn] = []
