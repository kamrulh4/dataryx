...
from core.auth.models import Secret, SecretInput
from core.database import models as db_models
from core.database.connection import get_db
from core.secret_manager.secret_manager import delete_secret as delete_secret_action
from core.secret_manager.secret_manager import store_secret
...
async def create_secret(
    ...
    """
    # Get user ID
    user_id = 1 if os.environ.get("DATARYX_MODE") == "electron" else current_user.id
