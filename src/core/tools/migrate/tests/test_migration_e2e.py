...
by the dataryx system - not just that the YAML/JSON structure is correct.
...
from core.dataryx.flow_graph import FlowGraph, add_connection

# Import actual dataryx system for verification
...
from core.schemas.output_model import RunInformation
...
from tools.migrate.migrate import migrate_dataryx
...
# =============================================================================
# BASELINE TEST - Verify dataryx system works without migration
# =============================================================================

class TestDataryxBaseline:
    """Verify the dataryx system works before testing migration."""
...
class TestLegacyMigration:
    ...
    These tests:
    1. Create flows using LEGACY schemas (simulating old .dataryx pickles)
    2. Pickle them
    3. Run migrate_dataryx()
    ...
    def test_join_migration_with_none_selects(self, temp_dir):
        ...
        # 2. Pickle it (simulating old .dataryx)
        pickle_path = temp_dir / 'old_join.dataryx'
        with open(pickle_path, 'wb') as f:
            pickle.dump(legacy_flow, f)

        # 3. Migrate to YAML
        yaml_path = temp_dir / 'migrated.yaml'
        migrate_dataryx(pickle_path, yaml_path, 'yaml')
    ...
    def test_filter_migration(self, temp_dir):
        ...
        # Pickle
        pickle_path = temp_dir / 'old_filter.dataryx'
        with open(pickle_path, 'wb') as f:
            pickle.dump(legacy_flow, f)
    ...
    def test_groupby_migration(self, temp_dir):
        ...
        # Pickle
        pickle_path = temp_dir / 'old_groupby.dataryx'
        with open(pickle_path, 'wb') as f:
            pickle.dump(legacy_flow, f)
    ...
    def test_select_migration(self, temp_dir):
        ...
        # Pickle
        pickle_path = temp_dir / 'old_select.dataryx'
        with open(pickle_path, 'wb') as f:
            pickle.dump(legacy_flow, f)
    ...
    def test_formula_migration(self, temp_dir):
        ...
        # Pickle
        pickle_path = temp_dir / 'old_formula.dataryx'
        with open(pickle_path, 'wb') as f:
            pickle.dump(legacy_flow, f)
    ...
    def test_sort_migration(self, temp_dir):
        ...
        # Pickle
        pickle_path = temp_dir / 'old_sort.dataryx'
        with open(pickle_path, 'wb') as f:
            pickle.dump(legacy_flow, f)
