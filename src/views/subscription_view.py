    ...
    def build_subscription(self):
        ...
        if is_licensed and license_info:
            if license_info.get("is_trial"):
                hw_status_text = f"Active Trial ({license_info.get('days_left', 0)} days left)"
        ...
        self.content = ft.Column(
            [
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ft.Text("Hardware Device License", size=15, weight=ft.FontWeight.W_600, color=ft.Colors.GREY_300),
                            ft.Divider(color=ft.Colors.GREY_800),
                            ft.Row(
                                [
                                    ft.Text("Hardware Status:", color=ft.Colors.GREY_500, size=13),
                                    ft.Text(hw_status_text, color=hw_status_color, size=13, weight=ft.FontWeight.BOLD)
                                ]
                            ),
                            ft.Row(
                                [
                                    ft.Text("Your Hardware ID:", color=ft.Colors.GREY_500, size=13),
                                    ft.Text(hwid, color=ft.Colors.WHITE, size=12, selectable=True, weight=ft.FontWeight.BOLD),
                                    ft.IconButton(
                                        icon=ft.Icons.COPY,
                                        icon_size=16,
                                        tooltip="Copy HWID",
