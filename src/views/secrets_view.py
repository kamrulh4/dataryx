...
class SecretsView(ft.Container):
    ...
    def build_secrets(self):
        ...
        subtitle = ft.Text(
            "Define SQL and cloud credentials securely stored locally in SQLite.",
        ...
        def load_connections():
            ...
            if not self.connections:
                conn_list.controls.append(
                    ft.Text(
                        "No database connections found. Add one below.",
                        color=t.TEXT_HINT,
                    )
                )
                return
                        ...
                        content=ft.Row(
                            [
                                    ...
                                    [
                                        ...
                                        ft.Column(
                                            [
                                                ...
                                                ft.Text(
                                                    f"{conn_type_driver} | Host: {conn.host} | Database: {conn.database}",
                                                    color=t.TEXT_HINT,
                                                    size=12,
                                                ),
                                            ],
                                ...
                                ft.IconButton(
                                    ...
                                    on_click=lambda _: self.delete_conn(
                                        conn.connection_name
                                    ),
                                ),
                            ],
        ...
        name_input = ft.TextField(
            label="Connection Name", height=42, text_size=13, border_color=t.BORDER
        )
        ...
        host_input = ft.TextField(
            label="Host", height=42, text_size=13, border_color=t.BORDER
        )
        port_input = ft.TextField(
            label="Port", height=42, text_size=13, border_color=t.BORDER
        )
        user_input = ft.TextField(
            label="User", height=42, text_size=13, border_color=t.BORDER
        )
        ...
        db_input = ft.TextField(
            label="Database Name", height=42, text_size=13, border_color=t.BORDER
        )
        ...
        def add_connection(e):
            ...
            new_conn = FullDatabaseConnection(
                ...
                port=(
                    int(port_input.value.strip())
                    if not is_sqlite and port_input.value.strip()
                    else (None if is_sqlite else 5432)
                ),
